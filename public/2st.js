...
import { jsPsych } from "https://cdn.jsdelivr.net/npm/jspsych@7.0.0/dist/jspsych.js";
import { CallFunctionPlugin } from "https://cdn.jsdelivr.net/npm/jspsych@7.0.0/dist/plugins/jspsych-call-function.js";
import { CanvasKeyboardResponsePlugin } from "https://cdn.jsdelivr.net/npm/jspsych@7.0.0/dist/plugins/jspsych-canvas-keyboard-response.js";
import { InstructionsPlugin } from "https://cdn.jsdelivr.net/npm/jspsych@7.0.0/dist/plugins/jspsych-instructions.js";
...
function save_results(participant_id, birthday) {
  // 参加者のデータをJSONに変換
  const result_data = JSON.stringify(two_step_task.data);
  // 実験名（2st または 3st）を渡す
  const experiment_name = 'experiment1';  // もしくは 'experiment2'
