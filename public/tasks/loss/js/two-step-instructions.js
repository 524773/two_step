...
const instructions_3a = {
  type: jsPsychTwoStepInstructions,
  pages: [
    "<p>ゲーム終了時に、集めた「石」の合計量が変換され、</p><p>実際の謝礼金に反映されます。 <b>（基本の謝礼金の下限は下回りません）</b>.</p>",
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人が「石」を渡してくるか注意して見つけることです。</p>",
    "「報酬の宇宙群」ではできる限り多くの「ダイアの原石」をあつめ、「罰則の宇宙群」では「ただの石」を回避するために、<b>以下に３つの手がかりがあります。</b></p><p>どうか、注意して読まれてください。</p>",
    "<p><b>Hint #1:</b>宇宙人が「石」をわたす可能性は時間の経過とともに変化しますが、この変化はゆっくりとしています。ですから、どの宇宙人があなたに「石」を渡しているかを覚えておく必要があります。今あなたに「石」を渡している宇宙人は、しばらくあなたに「石」を渡し続ける可能性が高いからです。</p>",
    "<p><b>Hint #2:</b>「石」を手に入れるかどうかは、取引する宇宙人にのみ依存します。どのロケット船がその宇宙人のところに連れてきたか、宇宙人を選ぶ順序、または取引しないことを選択した宇宙人などは影響しません。</p>",
...
const quiz_3 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が「石」を渡す確率は、選択したロケット船によって異なってくる。",
...
var INSTRUCTIONS_SKIP = {
  ...
  stimulus: '<p>これから、「２段階タスク」実験の <b>説明とインストラクションが始まります。</b></p><p>インストラクションを始めるには, キーボードの「１」を押してください。</p>',
  choices: ["1","2"]
}
