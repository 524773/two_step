...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。実際に宇宙人と取引するには、最初に搭乗ロケットを選択し、訪問先の宇宙人を選択する２段階の選択が必要になります。ここではまず後半部分の宇宙人との取引を体験します。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。</p><p>どの宇宙人があなたに好条件の取引をする可能性が高いか試行してください。</p>",
