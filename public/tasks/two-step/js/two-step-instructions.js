...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。普通は得をしたり、損をしますが、こちらは「やさしい宇宙群」のため、プラスマイナス０の取引か利得をえる取引だけになります。</p>",
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 1}).count() == 0) {
      trial.pages.unshift(
        "<p>これから「宇宙人との資源交換取引ゲーム」ゲームの<b>説明と体験を開始します。</b></p><p>下のNextボタンを使うか、キーボードの矢印キー<br>を使い、進めてください。</p>",
