...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。普通は得をしたり、損をしますが、こちらは「やさしい宇宙群」のため、プラスマイナス０の取引か利得をする取引だけになります。</p>",
    ...
    "<p>惑星を訪れると、取引する宇宙人を選びます。</p><p>宇宙人と取引すると<b>我々の協力者で、通訳である感情表現の豊かな「ワープさん」が</b><b>取引結果に応じた表情を見せます。</b></p>",
    ...
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>「好条件の取引（プラス１０円）」をしてくれる<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をみせます。</p>",
