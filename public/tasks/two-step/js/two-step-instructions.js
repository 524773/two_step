...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。次は実際に宇宙人と体験しましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。どの宇宙人が「あたり」の「石」を渡す可能性が高いか練習してください。</p>",
...
const instructions_2a = {
  ...
  pages: [
    ...
    `<p>各ロケットは「たいてい」は、到着する惑星がきまっています。</p><p>このロケットならば、あの宇宙人と出会える、と「たいてい」わかっているのです。</p><p>逆に、あるロケットは「たいてい」別の惑星の宇宙人のところへ行くのです。</p>`,
