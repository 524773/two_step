...
const instructions_1a = {
  ...
  pages: [
    ...
    "<p>通訳の「ワープさん」は、</p><p>あなたが取引で得をすると、<b>あなたに向けて「にこにこ顔」をみせます。</b></p><p>表情はこちらです。（画像は練習用です）</p>",
    "<p>プラスマイナス０の取引結果になれば</p><p>現状維持なので、「真顔」になります。</p><p>真顔はこちらです。（画像は練習用です）</p>",
    "<p>取引する宇宙人を選ぶには、キーボードの</p><p><b>左←か右→の矢印</b>キーを使います。</p>",
    "<p>宇宙人たちは<b>「毎回かならず」、</b></p><p>あなたにとって「好条件の取引（プラス１０円）」をする<b>わけではありません。</b></p><p>ときおりプラスマイナス０の取引をします。</p>",
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁にあなたに好条件の取引をする期間があります。</b></p><p>つまり、その時期を把握すれば、選択することで<b>多くの利益を</b>、</p><p><b>得られます。</b></p>",
...
const quiz_1 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人が、あなたにとって好条件の取引（＋１０円）をする時期か判断し、選択することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期においてほかの宇宙人よりも、あなたにとって好条件の取引（＋１０円）を頻繁にします。",
  ],
  options: [
...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。実際に宇宙人と取引するには、最初に搭乗ロケットを選択し、訪問先の宇宙人を選択する２段階の選択が必要になります。ここではまず後半部分の宇宙人との取引を体験します。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。</p><p>どの宇宙人が、あなたに好条件の取引をするか試行してください。</p>",
    　 "<p><b>ヒント:</b>宇宙人はときどき画面にあらわれる<br>左右の位置をかえてきます。左右がかわっても<br>あなたにとって好条件の取引（＋１０円）をする確率は変わりません。</p>",
...
const practice_1_help_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お困りですか。</p><p>覚えておいてください。<b>たいていの場合</b>にあなたにとって好条件の取引をする宇宙人を<br><b>選ぶのです。</b></p>",
      "<p>もう一度やってみましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。どの宇宙人がよさそうか判断するチャンスが 10 回あります。</p>",
    ],
...
const instructions_2a = {
  ...
  pages: [
    ...
    `<p>今度は、（１）の、訪問するロケットの紹介です。</p><p>以下に、選択できるロケットの例を2つ示します:<br>the <b><font color='${practice_info.font_colors[0]}'>${practice_info.rocket_names[0]}</font></b> and <b><font color='${practice_info.font_colors[1]}'>${practice_info.rocket_names[1]}</font></b> rocket ships.</p>`,
    `<p>各ロケットは「たいてい」は、到着する惑星がきまっています。</p><p>このロケットならば、あの宇宙人と出会える、と「たいてい」わかっているのです。</p>`,
    "<p>もし特定の惑星、特定の宇宙人と出会いたいなら, そこへ連れていって<br>くれる可能性が最も高い色のロケットを選ぶ必要があります。</p>",
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人があなたにとって好条件の取引（＋１０円）が多いか、わかったのではないでしょうか？</p>"
      )
    }
...
const instructions_3a = {
  ...
  pages: [
    ...
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人が、あなたにとって「好条件の取引」をするか注意してみつけ、選択することです。</p>",
    "できる限り<b>好条件の取引期間</b>を把握し<b>プラス１０円</b>を選んでください。<b>以下が３つの攻略手がかりです。</b></p><p>注意してお読みください。</p>",
    "<p><b>Hint #1:</b>宇宙人があなたにとって「好条件の取引」をする確率は時間の経過とともに変化しますが、この変化はゆっくりです。そのため、どの宇宙人が、好条件の取引をしているか覚えておく必要があります。今あなたに好条件の取引をする宇宙人は、しばらく続ける可能性が高いからです。</p>",
...
const quiz_3 = {
  type: jsPsychTwoStepComprehension,
  prompts: [
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が、あなたにとって「好条件の取引」をする確率は、時間の経過とともに変化する。",
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が、あなたにとって「好条件の取引」をする確率は、選択したロケットによって異なる。",
