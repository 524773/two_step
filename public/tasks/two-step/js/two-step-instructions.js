...
const instructions_1a = {
  ...
  pages: [
    ...
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>あなたに「好条件の取引（プラス１０円）」をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
...
const quiz_1 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人があなたに好条件の取引（＋１０円）をする時期か判断し、選択することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期において、ほかの宇宙人よりもあなたに好条件の取引（＋１０円）を頻繁にします。",
  ],
  options: [
...
const instructions_1b_node = {
  timeline: [{
    ...
    　 "<p><b>ヒント:</b>宇宙人はときどき画面にあらわれる<br>左右の位置をかえてきます。左右がかわっても<br>好条件の取引（＋１０円）をする確率は変わりません。</p>",
...
const practice_1_help_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お困りですか。</p><p>覚えておいてください。<b>たいていの場合</b>にあなたに好条件の取引をする宇宙人を<br><b>選ぶのです。</b></p>",
...
const instructions_2a = {
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人があなたに好条件の取引（＋１０円）が多いか、わかったのではないでしょうか？</p>"
      )
    }
...
const instructions_3a = {
  ...
  pages: [
    ...
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人があなたに「好条件の取引」をするか注意してみつけ、選択することです。</p>",
    "できる限り<b>好条件の取引</b>を把握し<b>プラス１０円</b>を選んでください。<b>以下が３つの攻略手がかりです。</b></p><p>注意してお読みください。</p>",
    "<p><b>Hint #1:</b>宇宙人があなたに「好条件の取引」をする確率は時間の経過とともに変化しますが、この変化はゆっくりです。そのため、どの宇宙人が、好条件の取引をしているか覚えておく必要があります。今あなたに好条件の取引をする宇宙人は、しばらく続ける可能性が高いからです。</p>",
...
const quiz_3 = {
  type: jsPsychTwoStepComprehension,
  prompts: [
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が、あなたに「好条件の取引」をする確率は、時間の経過とともに変化する。",
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が、あなたに「好条件の取引」をする確率は、選択したロケットによって異なる。",
