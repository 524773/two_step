...
const instructions_1a = {
  ...
  pages: [
    ...
    "<p>宇宙人たちは<b>「毎回かならず」、</b></p><p>あなたにとって「好条件の取引（プラス１０円）」をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。実際に宇宙人と取引するには、最初に搭乗ロケットを選択し、到着さきの宇宙人を選択する２段階の選択が必要になりますが、ここでは先に後半部分の宇宙人との取引を体験しましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。</p><p>どの宇宙人があなたに好条件の取引をする可能性が高いか試行してください。</p>",
...
const instructions_2a = {
  ...
  pages: [
    ...
    `<p>今度は、（１）の、訪問するロケット選びの体験です。</p><p>以下に、選択できるロケットの例を2つ示します:<br>the <b><font color='${practice_info.font_colors[0]}'>${practice_info.rocket_names[0]}</font></b> and <b><font color='${practice_info.font_colors[1]}'>${practice_info.rocket_names[1]}</font></b> rocket ships.</p>`,
