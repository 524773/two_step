...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームでは、宇宙人を探して、挨拶して、お金を増やしたり減らさないようにします。</p>",
    ...
    "<p>惑星を訪れると、挨拶する宇宙人を選べます。</p><p>宇宙人に挨拶すると<b>「あたり」の「変身の顔」か</b><b>それ以外の「真顔」を見せます。ただし、どの宇宙人も決まった同じ変身しかできません</b></p>",
    "<p>「変身の顔」はにこにこ宇宙群では「あたり」が「にこにこ顔」になり、</p><p>ぷんぷん宇宙群では「あたり」が「ぷんぷん顔」になります。</p><p>「変身の顔」はこちらです。（練習ではにこにこ顔で実施します）</p>",
    "<p>「真顔」はにこにこ宇宙群でもぷんぷん宇宙群でも、</p><p>「プラス」にも「マイナス」にもなりません。</p><p>「真顔」はこちらです。(練習用の画像です)  </p>",
    "<p>挨拶する宇宙人を選ぶには、キーボードの</p><p><b>左←か右→の矢印</b>キーを使います。</p>",
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>同じ「変身」をする<b>わけではありません。</b></p><p>同じにみえて、ときおり「真顔」をみせます。</p>",
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁に「あたり（変身）」をみせる期間があります。</b></p><p>つまり、その時期を把握すれば、<b>多く「あたり」を「得ること」と</b>、</p><p><b>逆に「避ける」こともできます。</b></p>",
    "<p>あなたの目標は、ある時期に最も「あたり（変身）」をする可能性のある宇宙人を見つけること。<b>つまり、「あたり」がプラスの「にこにこ宇宙群」では、彼らの変身をふやす選択をし、反対に、「あたり」がマイナスの「ぷんぷん宇宙群」では、彼らの変身を避けることです。</b></p>",
  ],
...
const quiz_1 = {
  ...
  prompts: [
    "挨拶する宇宙人を選択するには、どのキーを使用しますか?",
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人が「あたり（変身）」をみせる可能性が高いかを判断することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期において、ほかの宇宙人よりも「あたり（変身）」を頻繁にみせます。",
  ],
  options: [
...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。次は実際に宇宙人と体験しましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>挨拶する宇宙人を選択します。</p><p>どの宇宙人が「あたり」の「変身」をみせる可能性が高いか試行してください。</p>",
    　 "<p><b>ヒント:</b>宇宙人はときどき画面にあらわれる<br>位置をかえてきます。位置がかわっても<br>「あたり」をみせる確率は変わりません。</p>",
...
const practice_1_help_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お困りですか。</p><p>覚えておいてください。<b>たいていの場合</b>に「あたり」をみせる宇宙人を<br><b>探してみるのです。</b></p>",
      "<p>もう一度やってみましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>挨拶する宇宙人を選択します。どの宇宙人が「あたり」の「変身」をする可能性が高いか判断するチャンスが 10 回あります。</p>",
    ],
...
const instructions_2a = {
  ...
  pages: [
    ...
    `<p>各ロケットは「たいてい」は、到着する惑星がきまっています。</p><p>このロケットならば、あの宇宙人と出会える、と「たいてい」わかっているのです。</p><p>逆に、あるロケットは「たいてい」別の惑星の宇宙人のところへ行きます。</p>`,
...
const instructions_3a = {
  ...
  pages: [
    ...
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人が「あたり」をみせるか注意してみつけることです。</p>",
    "「にこにこ宇宙群」ではできる限り「あたり」<b>（プラス１０円）</b>をあつめ、「ぷんぷん宇宙群」では「あたり」<b>（マイナス１０円）</b>を回避してください。<b>以下が３つの攻略手がかりです。</b></p><p>注意してお読みください。</p>",
    "<p><b>Hint #1:</b>宇宙人が「あたり」をみせる確率は時間の経過とともに変化しますが、この変化はゆっくりです。そのため、どの宇宙人があなたに「あたり」をみせているかを覚えておく必要があります。今あなたに「あたり」をみせている宇宙人は、しばらく「あたり」をみせ続ける可能性が高いからです。</p>",
    "<p><b>Hint #2:</b>「あたり」になるかどうかは、挨拶する宇宙人にのみ依存します。どのロケットがその宇宙人のところに連れてきたか、宇宙人を選ぶ順序、選択しなかった経験（記録）などは影響しません。</p>",
    "<p><b>Hint #3:</b>挨拶したい宇宙人がいる時は、その宇宙人がいる惑星に<br>連れて行ってくれる可能性が最も高いロケットを選んでください。"
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 3}).count() == 0) {
      trial.pages.unshift(
        ...
        "<p>にこにこ宇宙群に移動した方は謝礼金の基本は１，２００円です。（なるべく増やしましょう）</p>",
        "<p>ぷんぷん宇宙群に移動した方は謝礼金の基本は１，９００円です。（なるべく減らさないように）</p>",
        "<p>どちらになるかはランダムですが、「どちらも同じ程度の金額」が期待されますので、がんばって下さい。</p>",
      )
    }
...
const quiz_3 = {
  type: jsPsychTwoStepComprehension,
  prompts: [
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が「あたり」をみせる確率は、時間の経過とともに変化する。",
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が「あたり」をみせる確率は、選択したロケットによって異なる。",
