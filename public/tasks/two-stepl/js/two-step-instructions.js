...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。その結果、得をしたり、損をします。ただし、こちらは「シビアな宇宙群」のため、プラスマイナス０の取引か損失する取引だけになります。</p>",
    ...
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁にシビアになる期間があります。</b></p><p>つまり、その時期を把握すれば、回避することで<b>損失を</b>、</p><p><b>避けられます。</b></p>",
    "<p>つまり、あなたは今回、「やさしい宇宙群」と「シビアな宇宙群」のうち、「シビアな宇宙群」で取引するので、シビアな取引をする宇宙人の期間を把握し、<b>損失を避けることが目標です。</b></p>",
  ],
...
const instructions_2a = {
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人がシビアか、わかったのではないでしょうか？</p>"
      )
    }
