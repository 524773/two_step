...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。その結果、普通は得をしたり、損をしますが、こちらは「きびしい宇宙群」のため、プラスマイナス０の取引か損失する取引だけになります。</p>",
    ...
    "<p>惑星を訪れて、取引する宇宙人を選びます。</p><p>宇宙人と取引すると、その結果、<b>我々の協力者で、通訳である感情表現の豊かな「ワープさん」が</b><b>取引結果に応じた表情を見せます。</b></p>",
    "<p>通訳の「ワープさん」は取引の結果、</p><p>損をすると「ぷんぷん顔」になります。</p><p>損失の表情はこちらです。</p>",
    "<p>損をしない取引結果になれば</p><p>プラスマイナス０の現状維持なので、真顔になります。</p><p>「真顔」はこちらです。(こちらは練習用のワープさんの画像です)  </p>",
    "<p>取引する宇宙人を選ぶには、キーボードの</p><p><b>左←か右→の矢印</b>キーを使います。</p>",
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>シビアな取引（－１０円）をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁にシビアになる期間があります。</b></p><p>つまり、その時期を把握すれば、回避することで<b>多くの損失を</b>、</p><p><b>避けられます。</b></p>",
    "<p>あなたは今回、「やさしい宇宙群」と「きびしい宇宙群」のうち、「きびしい宇宙群」で取引するので、シビアな取引（－１０円）をする宇宙人の期間を把握し、<b>損失を避けることが目標です。</b></p>",
  ],
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 1}).count() == 0) {
      trial.pages.unshift(
        "<p>これから「宇宙人との資源交換取引ゲーム」の<b>説明と体験を開始します。</b></p><p>下のNextボタンを使うか、キーボードの矢印キー<br>を使い、インストラクションを進めてください。</p>",
...
const quiz_1 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人がシビアな取引（－１０円）をする時期か判断し、回避することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期において、ほかの宇宙人よりもシビアな取引（－１０円）を頻繁にします。",
  ],
  options: [
...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。実際に宇宙人と取引するには、最初に搭乗ロケットを選択し、到着さきの宇宙人を選択する２段階の選択が必要になりますが、ここでは先に宇宙人との取引を体験しましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。</p><p>どの宇宙人が「あたりの顔」をみせる可能性が高いか試行してください。</p>",
    　 "<p><b>ヒント:</b>宇宙人はときどき画面にあらわれる<br>左右の位置をかえてきます。左右がかわっても<br>「シビアな取引（－１０円）」をする確率は変わりません。</p>",
...
const practice_1_help_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お困りですか。</p><p>覚えておいてください。<b>たいていの場合に</b>プラスマイナス０の取引をする宇宙人を<br><b>覚えるのです。</b></p>",
      "<p>もう一度やってみましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。どの宇宙人が良さそうか判断するチャンスが 10 回あります。</p>",
    ],
...
const instructions_2a = {
  ...
  pages: [
    ...
    `<p>ここからは、前半部分の選択である、惑星を訪問するロケット選びも含めた、通しでの練習です。</p><p>以下に、ロケットの例を2つ示します:<br>the <b><font color='${practice_info.font_colors[0]}'>${practice_info.rocket_names[0]}</font></b> and <b><font color='${practice_info.font_colors[1]}'>${practice_info.rocket_names[1]}</font></b> rocket ships.</p>`,
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人が今回の期間ではシビアか（－１０円が多いか）、わかったのではないでしょうか？</p>"
      )
    }
...
const instructions_2b = {
  ...
  pages: [
    ...
    "<p><b>ご注意を:</b>ロケットの表示位置は、ときどき左側と右側に<br>いれかわります。ただ、同じロケットならば、左側にあっても<br>右側にあっても、目的地の惑星への到着確率は変わりません。</p>"
  ],
...
const instructions_3a = {
  ...
  pages: [
    ...
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人が「シビアな取引」をするか注意してみつけ、回避することです。</p>",
    "できる限り<b>プラスマイナス０</b>をめざし、シビアな取引<b>（マイナス１０円）</b>を回避してください。<b>以下が３つの攻略手がかりです。</b></p><p>注意してお読みください。</p>",
    "<p><b>Hint #1:</b>宇宙人が「シビアな取引」をする確率は時間の経過とともに変化しますが、この変化はゆっくりです。そのため、どの宇宙人が、シビアな取引をしているかを覚えておく必要があります。今あなたにシビアな取引をする宇宙人は、しばらく続ける可能性が高いからです。</p>",
    "<p><b>Hint #2:</b>「シビアな取引」になるかどうかは、取引する宇宙人にのみ依存します。どのロケットがその宇宙人のところに連れてきたか、宇宙人を選ぶ順序、選択しなかった経験（記録）などは影響しません。</p>",
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 3}).count() == 0) {
      trial.pages.unshift(
        ...
        "<p>あなたは今回、「きびしい宇宙群」に運ばれますが、「どちらも同じ程度の金額」が期待されますので、がんばって下さい。</p>",
      )
    }
...
const quiz_3 = {
  type: jsPsychTwoStepComprehension,
  prompts: [
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が「シビアな取引」をする確率は、時間の経過とともに変化する。",
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;宇宙人が「シビアな取引」をする確率は、選択したロケットによって異なる。",
    "<i>True</i> or <i>False</i>:&nbsp;&nbsp;このゲーム内で獲得した「お金」が、プラスの場合もマイナスの場合も、精算されて実際の謝礼金に影響する。",
  ],
  options: [
    ["正しい", "違う"],
    ["正しい", "違う"],
