...
const instructions_1a = {
  ...
  pages: [
    ...
    "<p>惑星を訪れて、取引する宇宙人を選びます。</p><p>宇宙人と取引すると<b>我々の協力者で、通訳である感情表現の豊かな「ワープさん」が</b><b>取引結果に応じた表情を見せます。</b></p>",
    "<p>通訳の「ワープさん」は、</p><p>取引で損をすると「ぷんぷん顔」になります。</p><p>表情はこちらです。</p>",
    "<p>プラスマイナス０の取引結果になれば</p><p>現状維持なので、「真顔」になります。</p><p>真顔はこちらです。(こちらは練習用のワープさんの画像です)  </p>",
