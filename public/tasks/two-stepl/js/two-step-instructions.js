...
const instructions_1a = {
  ...
  pages: [
    ...
    "<p>宇宙人たちは<b>「毎回かならず」、</b></p><p>あなたにとって「悪条件の取引（マイナス１０円）」をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
...
const instructions_2a = {
  type: jsPsychTwoStepInstructions,
  pages: [
    "<p>次に、惑星への訪問を体験します。宇宙人と取引するためには２段階の選択が必要です。（１）訪問するロケットを選ぶ。（２）取引する宇宙人び選ぶ。★つまり、さきほどの宇宙人との取引は、（２）の部分でした。</p>",
    `<p>今度は、（１）の、訪問するロケット選びの体験です。</p><p>以下に、ロケットの例を2つ示します:<br>the <b><font color='${practice_info.font_colors[0]}'>${practice_info.rocket_names[0]}</font></b> and <b><font color='${practice_info.font_colors[1]}'>${practice_info.rocket_names[1]}</font></b> rocket ships.</p>`,
