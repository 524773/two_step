...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。その結果、普通は得をしたり、損をしますが、こちらは「シビアな宇宙群」のため、プラスマイナス０の取引か損失する取引だけになります。</p>",
    ...
    "<p>通訳の「ワープさん」は資源取引の結果、</p><p>損をすると「ぷんぷん顔」になります。</p><p>損失の表情はこちらです。</p>",
    ...
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>シビアな取引をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁にシビアになる期間があります。</b></p><p>つまり、その時期を把握すれば、回避することで<b>多くの損失を</b>、</p><p><b>避けられます。</b></p>",
    "<p>あなたは今回、「やさしい宇宙群」と「シビアな宇宙群」のうち、「シビアな宇宙群」で取引するので、シビアな取引をする宇宙人の期間を把握し、<b>損失を避けることが目標です。</b></p>",
  ],
...
const quiz_1 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人がシビアな取引をする時期か判断し、回避することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期において、ほかの宇宙人よりもシビアな取引を頻繁にします。",
  ],
  options: [
...
const instructions_2a = {
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人が今回の期間ではシビアか、わかったのではないでしょうか？</p>"
      )
    }
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 3}).count() == 0) {
      trial.pages.unshift(
        ...
        "<p>損失をする「シビアな宇宙群」に移動した方は謝礼金の基本は１，９００円です。（減ってしまうからです）</p>",
        "<p>あなたは今回、「シビアな宇宙群」に運ばれますが、「どちらも同じ程度の金額」が期待されますので、がんばって下さい。</p>",
      )
    }
