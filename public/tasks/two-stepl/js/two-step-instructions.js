...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。その結果、得をしたり、損をしたりします。こちらはシビアな宇宙群のため、プラスマイナス０の取引か損失の取引しかできません。</p>",
    ...
    "<p>損をしない取引結果にできれば</p><p>プラスマイナス０の現状維持ができ、真顔になります。</p><p>「真顔」はこちらです。(こちらは練習用のワープさんの画像です)  </p>",
    ...
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁にシビアになる期間があります。</b></p><p>つまり、その時期を把握すれば、回避することで<b>多くのプラスマイナスゼロ取引ができ</b>、</p><p><b>損失を避けることができます。</b></p>",
    "<p>つまり、あなたは今回、シビアな宇宙群で取引するので、ある時期に最もシビアな取引をする宇宙人を把握し、<b>損失を避けることが目標です。</b></p>",
  ],
