...
const instructions_1a = {
  ...
  pages: [
    "<p>このゲームは、宇宙人と資源の取り引きをします。取引は普通、得をしたり、損をしますが、こちらは「きびしい宇宙群」のため、プラスマイナス０の取引か損する取引だけになります。</p>",
    ...
    "<p>惑星を訪れたら、取引する宇宙人を選びます。</p><p>宇宙人と取引すると<b>我々の協力者で、通訳である感情表現の豊かな「ワープさん」が</b><b>取引結果に応じた表情を見せます。</b></p>",
    ...
    "<p>宇宙人たちは<b>「毎回かならず」</b></p><p>「悪条件の取引（－１０円）」をする<b>わけではありません。</b></p><p>同じにみえて、ときおりプラスマイナス０の取引をします。</p>",
    "<p>宇宙人たちは<b>ある時期、ほかの宇宙人よりも</b></p><p><b>頻繁に悪条件の取引をする期間があります。</b></p><p>つまり、その時期を把握すれば、回避することで<b>多くの損失を</b>、</p><p><b>避けられます。</b></p>",
    "<p>あなたは今回、「やさしい宇宙群」と「きびしい宇宙群」のうち、「きびしい宇宙群」で取引するので、悪条件の取引（－１０円）を避け、<b>謝礼金を減らさないことが目標です。</b></p>",
  ],
...
const quiz_1 = {
  ...
  prompts: [
    ...
    "<i>True</i> or <i>False</i>:&nbsp;あなたの目標は、どの宇宙人が悪条件の取引（－１０円）をする時期か判断し、回避することです。",
    "<i>True</i> or <i>False</i>:&nbsp;ある宇宙人は、ある時期において、ほかの宇宙人よりも悪条件の取引（－１０円）を頻繁にします。",
  ],
  options: [
...
const instructions_1b_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お見事です。実際に宇宙人と取引するには、最初に搭乗ロケットを選択し、到着さきの宇宙人を選択する２段階の選択が必要になりますが、ここでは先に後半部分の宇宙人との取引を体験しましょう。</p><p>次の画面で<b>左/右の矢印キーを使って</b>取引する宇宙人を選択します。</p><p>どの宇宙人が「悪条件の取引」をする可能性が高いか試行してください。</p>",
    　 "<p><b>ヒント:</b>宇宙人はときどき画面にあらわれる<br>左右の位置をかえてきます。左右がかわっても<br>「悪条件の取引（－１０円）」をする確率は変わりません。</p>",
...
const practice_1_help_node = {
  timeline: [{
    type: jsPsychTwoStepInstructions,
    pages: [
      "<p>お困りですか。</p><p>覚えておいてください。<b>たいていの場合に</b>悪条件の取引をする宇宙人を<br><b>避けるのです。</b></p>",
...
const instructions_2a = {
  ...
  on_start: function(trial) {
    ...
    if (jsPsych.data.get().filter({quiz: 2}).count() == 0) {
      trial.pages.unshift(
        "<p>いかがですか。どの宇宙人が今回の期間では悪条件の取引か（－１０円が多いか）、わかったのではないでしょうか？</p>"
      )
    }
...
const instructions_3a = {
  ...
  pages: [
    ...
    "<p>あなたの目的はいつ（時間の経過とともに）、どの宇宙人が「悪条件の取引」をするか注意してみつけ、回避することです。</p>",
    "できる限り<b>悪条件の取引の期間</b>を把握し、<b>マイナス１０円</b>を回避してください。<b>以下が３つの攻略手がかりです。</b></p><p>注意してお読みください。</p>",
    "<p><b>Hint #1:</b>宇宙人が「悪条件の取引」をする確率は時間の経過とともに変化しますが、この変化はゆっくりです。そのため、どの宇宙人が、悪条件の取引をしているかを覚えておく必要があります。今あなたに悪条件の取引をする宇宙人は、しばらく続ける可能性が高いからです。</p>",
    "<p><b>Hint #2:</b>「悪条件の取引」になるかどうかは、取引する宇宙人にのみ依存します。どのロケットがその宇宙人のところに連れてきたか、宇宙人を選ぶ順序、選択しなかった経験（記録）などは影響しません。</p>",
