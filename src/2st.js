...
import { jsPsych } from "jspsych"; // jsPsychのインポート
import { CallFunctionPlugin } from "@jspsych/plugin-call-function";
import { CanvasKeyboardResponsePlugin } from "@jspsych/plugin-canvas-keyboard-response"; // ここに必要なプラグインをインポート
import { InstructionsPlugin } from "@jspsych/plugin-instructions"; // インストラクション用のプラグインもインポート
